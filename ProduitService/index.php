       ...
       <div><img src="../resources/logo_v1.svg" alt="logo ver.1" height="200px" id="logo" ></div>
        ...
        <div class="items">
            ...
            <p >le kit standard est un de nos appareils vendu, d'accès à connexion satellite .<br>
                               ...
                               Le materiel de cette catégorie disposent  <br/> des caractéristiques suivantes : <br></p>
            ...
            <div class=" el">
                ...
                <div class="third">
                                ...
                                <ul>
                                    ...
                                    <li>Latence : 50ms</li>
                                    <li>consommation électrique: 49 à 60 W</li>
                                    <li>Indice de protection : IP56</li>
                                    <li>Champ de vision : 123°</li>
                                    <li>Orientation:Automatique mécanisé</li>
                                </ul>
                                <span>Prix ... </span>
                            <button>Buy</button>
            ...
            <div class=" el">
                ...
                <div class="third">
                                ...
                                <ul>
                                    ...
                                    <li>Latence : 40ms</li>
                                    <li>consommation électrique: 145 à 165 W</li>
                                    <li>Indice de protection : IP56</li>
                                    <li>Champ de vision : 145°</li>
                                    <li>Orientation:Automatique mécanisé</li>
                                </ul>
                            <span>Prix ... </span>
                            <button>Buy</button>
            ...
            <div class=" el">
                ...
                <div class="third">
                                <ul>
                                    ...
                                    <li>Champ de vision : 145°</li>
                                    <li>Orientation:Automatique mécanisé</li>
                                    <li>indice de vent:Capacité de survie: 
                                        140km/h </li>
                                </ul>
                                <span>Prix ... </span>
                            <button>Buy</button>
